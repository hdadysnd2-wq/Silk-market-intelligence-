...
def deep_report(mission_reports: dict, analyst_summary: str, verdict: dict,
    ...
    parts.append(
        ...
        "الهامش) يُعرَض في **جدول Markdown** بعمود 'طريقة الاشتقاق' يُظهر "
        ...
        "القيمة | طريقة الاشتقاق | الافتراض |' — TAM = حجم الاستيراد "
        ...
        "المتجر وتاريخ الرصد | الدليل |' وسطر فاصل. كل صف يحمل متجره وتاريخ "
        "رصده ودليله (✓ مرصود برابط، ◐ مُقدَّر)، والسعر مُطبَّعاً لكل كجم أو "
        "وحدة. منتج بلا سعر مرصود = صفّ بفجوة معلنة لا حذف؛ وإن لم تُرصد "
