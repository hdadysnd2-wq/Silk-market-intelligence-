...
def deep_report(mission_reports: dict, analyst_summary: str, verdict: dict,
    ...
    parts.append(
        ...
        "- **2.1 بيانات قديمة**: أيّ رقم مرجعي (دخل/سكان/فقر من World Bank) "
        "سنته أقدم من خمس سنوات اذكر سنته صراحةً ووسمه «بيانات <السنة> — "
        "الأحدث المتاح» كي لا يُقرأ كأنه راهن (طبقة العرض تُلحِق الوسم آلياً "
        "أيضاً — اكتب السنة بين قوسين على الأقل).\n"
