...
MISSIONS: dict[str, dict] = {
    "pricing_scout": {
        ...
        "instructions": (
            ...
            "سلّم الأسعار موسوماً 'سعر جملة مرجعي (كومتريد، متوسط عبر "
            "مزيج الشحنات)' — نطاق مرجعي واسع لا سعر تجزئة فعلياً ولا "
            "بديلاً عن أسعار المتاجر الحقيقية أدناه، فقد يخلط درجات جودة "
    ...
    "consumer_culture": {
        ...
        "allowed_tools": ["web_search", "trends_interest", "lookup_reference",
                         "openalex_search", "eurostat_eu_signals"],
        "instructions": (
