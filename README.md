...
| `tools/fetch_hs_codes.py` | [متروكة] أداة تشغيل قديمة كانت تجلب مرجع HS من Comtrade وتوسّع البذرة الجزئية السابقة — لا حاجة عملية بعد ترحيل `data/hscodes_full.csv` الكامل رسمياً. |
