...
_CLIENT_SANITIZE = [
    ...
    # أقسامٍ داخليّ (§4b/§8/§10.3…) لا يخصّ العميل ويُبدَّل بصريًّا في RTL —
    # يُزال من سطح العميل. المصدر مُصلَح (silk_decision/silk_render) وهذه شبكة
    # أمان لأيّ تشغيلة مخزَّنة قديمة أو صياغةٍ يردّدها النموذج.
    (re.compile(r"\s*§\s*[\w.]+"), ""),
