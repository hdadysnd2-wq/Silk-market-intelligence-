...
If ~12–18 sessions is too long, ship **v1-minus = #1–#5 + G3 + G4.1**, deferring **G4.2 / G4.3 / G5 / G6** (and #6/AWS) to post-v1.
...
**Net:** for GCC/EU target markets (Silk's likely first paying customers), v1-minus is client-visibly **indistinguishable** from full v1. The only real client-facing sacrifice — EU-shaped compliance language for non-EU/non-GCC destinations — is bounded and honestly gapped, not fabricated. Recommended as the first shippable milestone, with G4.2/G5 as fast-follows.
