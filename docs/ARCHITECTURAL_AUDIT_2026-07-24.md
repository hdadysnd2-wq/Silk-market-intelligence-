...
4. **G layer — resume at G3 (G1/G2 DONE in #169).** Sequence `G3→G4.2/G4.3→G5→G6`. G4.1 lands as PR-b above; G5's lint subsumes PR-a's sweep. Note G3 = completing WS2's `IndicatorResolver` (still absent). This is roadmap #7 + #10 + #11 folded into the directive's G sequence.
